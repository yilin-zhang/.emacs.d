...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (fcitx evil lispy eldoc-box eglot flymake-diagnostic-at-point pdf-tools nyan-mode hl-todo symbol-overlay shell-pop ivy-rich gnuplot-mode yapfify amx highlight-indent-guides doom-modeline ibuffer-projectile projectile youdao-dictionary wttrin magit dashboard diredfl doom-themes aggressive-indent company-box ox-hugo rust-mode popwin cdlatex auctex hungry-delete olivetti rainbow-delimiters expand-region emojify diff-hl pyvenv yasnippet markdown-mode org-bullets all-the-icons neotree swiper counsel company which-key try diminish use-package))))
(custom-set-faces
