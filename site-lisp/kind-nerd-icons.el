...
(defvar kind-nerd-icons--icons
  `((unknown . ,(nerd-icons-faicon "nf-fa-question"))
    ...
    (interface . ,(nerd-icons-faicon "nf-fa-share" :face 'nerd-icons-orange))
    (i/f . ,(nerd-icons-faicon "nf-fa-share" :face 'nerd-icons-orange))
    (module . ,(nerd-icons-faicon "nf-fa-th_large" :face 'nerd-icons-orange))
    (mod . ,(nerd-icons-faicon "nf-fa-th_large" :face 'nerd-icons-orange))
    ...
    (type-parameter . ,(nerd-icons-faicon "nf-fa-arrows"))
    (param . ,(nerd-icons-faicon "nf-fa-arrows"))
