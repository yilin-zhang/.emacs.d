...
Third-party:
- =elispfl.el=: enhanced font-lock rules that make Emacs Lisp buffers more
  readable.
...
- =trashcat.el=: remove macOS applications and common residual files.
- =ocbud.el=: commands to open OpenCode sessions from Emacs.
